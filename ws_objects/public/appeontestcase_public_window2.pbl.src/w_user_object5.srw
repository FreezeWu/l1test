$PBExportHeader$w_user_object5.srw
forward
global type w_user_object5 from w_base_case
end type
type cb_1 from commandbutton within w_user_object5
end type
end forward
...
global w_user_object5 w_user_object5
...
//ls_array[Upperbound(ls_array) + 1 ] = "uso101_autonvodefine"			//edit you test case point name
