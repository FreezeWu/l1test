$PBExportHeader$w_woc501_close.srw
forward
global type w_woc501_close from window
end type
type cb_close from commandbutton within w_woc501_close
end type
type mle_describe from multilineedit within w_woc501_close
end type
type gb_1 from groupbox within w_woc501_close
end type
end forward
...
global w_woc501_close w_woc501_close
...
event clicked;close(w_woc501_close)
end event
