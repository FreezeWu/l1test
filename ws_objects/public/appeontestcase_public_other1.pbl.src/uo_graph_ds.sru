$PBExportHeader$uo_graph_ds.sru
forward
global type uo_graph_ds from graph
end type
end forward
...
integer spacing = 100
string title = "Persons  At Department"
...
global uo_graph_ds uo_graph_ds
